...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Mint Use Key - CRE8.pw Gateway') ?></title>
...
<body>
    <div class="min-h-screen" style="background: var(--background);">
        ...
        <main style="padding: 2rem; max-width: 800px; margin: 0 auto;">
            <div class="space-y-6">
                <div>
                    <h1>Mint Use Key</h1>
                    <p style="color: var(--muted-foreground);">Create a use key for sharing (cannot have posts:create or keys:issue)</p>
                ...
                <div class="card" style="padding: 1.5rem;">
                    <form method="POST" action="/api/keys/<?= htmlspecialchars($authorKeyId ?? '') ?>/use" id="mint-form" class="space-y-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="permissions" name="permissions" required class="input" placeholder="posts:read,comments:write">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="label" name="label" class="input" placeholder="Use key for recipient">
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary" style="width: 100%;">Mint Use Key</button>
                    </form>
                </div>
            </div>
        </main>
    ...
    <script>
        ...
        // TODO: Implement form submission to /api/keys/{authorKeyId}/use
        // TODO: Display new key credentials securely
        // TODO: Requires keys:issue permission
        // TODO: Validate that permissions don't include posts:create or keys:issue
    </script>
</body>
</html>
